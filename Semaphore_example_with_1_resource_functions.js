...
var sem = new semaphore.Semaphore(-3); // We declare 1 resource only
...
console.log("getStackSize()=" + sem.getStackSize());
//sem.emptyStack();
console.log("getNumberResources()=" + sem.getNumberResources());
sem.setDefaultPriority(20);
console.log("getDefaultPriority()=" + sem.getDefaultPriority());
sem.setDefaultTimeoutBetweenCallback(1000);
console.log("getDefaultTimeoutBetweenCallback()=" + sem.getDefaultTimeoutBetweenCallback());
//sem.setLifo(true);
console.log("getLifo()=" + sem.getLifo());
